    ...
    internal class TwoPaneSplitView : VisualElement
    {
        ...
        public TwoPaneSplitView()
        {
            ...
            styleSheets.Add(AssetDatabase.LoadAssetAtPath<StyleSheet>(
                "Packages/com.unity.sequences/Editor/Inspectors/UIBuilder/TwoPaneSplitView/TwoPaneSplitView.uss"));
        ...
        void OnSizeChange(GeometryChangedEvent evt)
        {
            ...
            m_Resizer.UpdateWindowHeight(maxLength);

            if (m_FixedPaneIndex == 0 && dragLinePos > maxLength - m_MinDimension)
            {
        ...
        class SquareResizer : MouseManipulator
        {
            ...
            public SquareResizer(TwoPaneSplitView splitView, int dir, float minWidth, Orientation orientation)
            {
                m_Orientation = orientation;
                m_MinWidth = minWidth;
                m_WindowHeight = splitView.resolvedStyle.height;
            ...
            public void UpdateWindowHeight(float windowHeight)
            {
            ...
            public void ApplyDelta(float delta)
            {
                ...
                newDimension = Mathf.Clamp(newDimension, m_MinWidth, m_WindowHeight - m_MinWidth);
